...
public final class BankServiceManager {
    ...
    public void sortByInterestRate(final SortOrder sortOrder) {
    ...
    public void sortDepositsByTerm(final SortOrder sortOrder) {
        if (sortOrder == SortOrder.ASC) {
    ...
    public void sortCreditByCreditInterest(final SortOrder sortOrder) {
